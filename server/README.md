...
<h1 align="center">Hi 🥳, 后端开发文档</h1>
<h3 align="center">使用 Golang 开发的 Prometheus 云原生运维监控告警系统后端</h3>
...
- [x] Zap：更完善的日志输入 [:octocat:](https://go.uber.org/zap)
- [x] Lumberjack：日志切割和压缩 [:octocat:](https://github.com/natefinch/lumberjack)
